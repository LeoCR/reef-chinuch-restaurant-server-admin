...
var storage = multer.diskStorage(
    {
        destination: path.resolve(__dirname+'/../../chinuch-restaurant/public/images/uploads/'),
...
const httpsOptions = {
    key: fs.readFileSync('/Users/leo/Documents/reef-chinuch-restaurant-server-admin/private/security/server.key'),
    cert: fs.readFileSync('/Users/leo/Documents/reef-chinuch-restaurant-server-admin/private/security/server.crt')
}
//Sync Database
models.sequelize.sync().then(function() {
    console.log('https://localhost:47642 works')
}).catch(function(err) {
...
const server=https.createServer(httpsOptions,app, (req, res) => {
    ...
    res.writeHead(200);
    res.end('hello world\n');
    console.log('https://localhost:47642 !');
}).listen(47642);